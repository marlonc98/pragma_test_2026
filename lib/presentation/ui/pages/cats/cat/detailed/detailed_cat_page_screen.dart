  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          vm.cat.data?.name ??
              i18n.translate(TextConstants.detailedCatPageDefaultTitle),
        ),
      ),
      body: LoaderScreenWidget(
        status: vm.cat,
        noResultsScreen: true,
        onRetry: vm.handleLoadCat,
        builder: (context, cat) => Column(
          children: [
                        ...
                        children: [
                          if (vm.cat.data!.adaptability != null)
                            CatFeatureItemWidget(
                              title: vm.localization.translate(
                                TextConstants.detailedCatPageAdaptability,
                              ),
                          ...
                          if (vm.cat.data!.intelligence != null)
                            CatFeatureItemWidget(
                              title: vm.localization.translate(
                                TextConstants.detailedCatPageItelligence,
                              ),
                          ...
                          if (vm.cat.data!.affectionLevel != null)
                            CatFeatureItemWidget(
                              title: vm.localization.translate(
                                TextConstants.detailedCatPageAffectionLevel,
                              ),
                          ...
                          if (vm.cat.data!.childFriendly != null)
                            CatFeatureItemWidget(
                              title: vm.localization.translate(
                                TextConstants.detailedCatPageChildFriendly,
                              ),
                          ...
                          if (vm.cat.data!.countryCode != null)
                            CatFeatureItemWidget(
                              title: vm.localization.translate(
                                TextConstants.detailedCatPageCountryCode,
                              ),
